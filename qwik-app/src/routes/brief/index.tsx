...
const briefCopy = {
  ...
  ro: {
    ...
    subtitle:
      'Raspunde la cateva intrebari, iar asta va fi suficient ca sa iti propun solutia potrivita.',
    navLabel: 'Navigare prin brief',
    nav: ['Date de contact', 'Despre proiect', 'Public tinta', 'Formatul site-ului', 'Detalii'],
    sections: {
      contacts: 'Date de contact',
      about: 'Despre proiect',
      audience: 'Public tinta',
    ...
    fields: {
      ...
      contactPlaceholder: 'Telegram / WhatsApp',
      projectDescription: 'Descrie pe scurt proiectul tau *',
      projectDescriptionPlaceholder: 'Ce faci si pentru cine',
      goal: 'De ce ai nevoie de site?',
      goalPlaceholder: 'Vanzari, prezentare, lansare de produs etc.',
      cta: 'Ce ar trebui sa faca utilizatorul pe site?',
      ctaPlaceholder: 'Sa lase cerere / sa cumpere / sa scrie',
      audience: 'Cine este clientul tau?',
      audiencePlaceholder: 'Varsta, tara, tip de clienti',
      usp: 'De ce va aleg anume pe voi?',
      uspPlaceholder: 'Unicitate, puncte forte',
      siteType: 'Ce tip de site iti trebuie?',
      references: 'Exemple de site-uri care iti plac',
      referencesPlaceholder: '2-5 linkuri',
      antiReferences: 'Ce nu iti place la alte site-uri',
      antiReferencesPlaceholder: 'Pe scurt, fara apa',
      style: 'Ce stil astepti?',
      stylePlaceholder: 'Minimalist, premium, tehnologic',
      materials: 'Ce ai deja?',
      materialsPlaceholder: 'Logo, texte, foto / nimic',
      deadline: 'Termene',
      deadlinePlaceholder: 'Urgent / in decurs de o luna / fara termen',
      budget: 'Buget orientativ',
      comment: 'Comentarii suplimentare',
      commentPlaceholder: 'Orice dorinte sau detalii importante',
    },
    selects: {
      choose: 'Alege',
      ...
      shop: 'Magazin online',
      unknown: 'Am nevoie de consultatie',
      budget1: 'pana la 500 €',
      budget2: '500-1000 €',
      budget3: '1000-2000 €',
      discussion: 'Se discuta',
    },
    submit: 'trimite brief-ul',
    success: 'Multumesc! Brief-ul a fost trimis.',
    error: 'Eroare la trimitere. Incearca mai tarziu.',
    headTitle: 'Brief pentru dezvoltarea site-ului | godevca',
    headDescription: 'Brief scurt si comod pentru comanda unui site',
  },
  en: {
